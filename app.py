...
st.subheader("Interprete de canciones")

st.markdown('<p class="custom-text">Todos amamos escuchar música ¿cierto? y por eso sé que a veces tenemos canciones que nos preguntamos como sonarían en inglés o en español, dependiendo de su idioma original, ¡por eso te invito que escribas la letra de tu canción favorita y la interpretes para que dejes de tener esa duda!</p>', unsafe_allow_html=True)
